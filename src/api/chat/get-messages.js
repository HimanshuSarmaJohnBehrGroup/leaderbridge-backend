        ...
        let requestAudio =
          await global.models.GLOBAL.REQUEST_PROFILE_ACCESS.find({
            ...
            $or: [
              ...
              { typeOfRequest: "revokeAudioAccess" },
            ],
            // typeOfRequest: "requestAudioAccess",
            // requestBy: ObjectId(user.id),
          })
        ...
        let requestVideo =
          await global.models.GLOBAL.REQUEST_PROFILE_ACCESS.find({
            ...
            $or: [
              ...
              { typeOfRequest: "revokeVideoAccess" },
            ],
            // requestBy: ObjectId(user.id),
          })
            .populate({
        ...
        if (checkBlockByMe) {
          ...
          const data4createResponseObject = {
            ...
            payload: {
              ...
              text: "You cannot reply to this conversation as you have blocked this user. You can unblock this user from the settings section",
            },
            logPayload: false,
          };
