...
module.exports = exports = {
  handler: async (req, res) => {
    ...
    const CheckVerificstion =
      await global.models.GLOBAL.FULLYVERIFYSATUS.findById(id);
    if (!CheckVerificstion) {
    ...
    try {
      if (id) {
        const deletedQuestion =
          await global.models.GLOBAL.FULLYVERIFYSATUS.findOneAndDelete({
            _id: id,
          });
        ...
        if (deletedQuestion) {
          const FindAndUpdate =
            await global.models.GLOBAL.USER.findOneAndUpdate(
              { _id: ObjectID(deletedQuestion.userId) },
              {
                $set: {
                  fullyVerified: false,
                  status: true,
          ...
          //                                   <span style="font-size: 16px; line-height: 22px; color: #323232; padding-bottom: 1.25rem; display: block;">Hi ${FindAndUpdate.name},</span>
          ...
          //                                       We are excited to have you on board. We are confident that you will find our platform to be a great resource for your professional development. We are here to help you in any way we can. Please feel free to reach out to us at any time.
          //                                   </p></br>
